...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSave.setOnClickListener((View v) -> {
            mAppExcutor.diskIO().execute(() -> {
                ...
                BitmapUtils.deletePhoFile(this, mTempPhotoPath);

                // Save the image
                BitmapUtils.savePhoto(this, mResultsBitmap);
        ...
        mShare.setOnClickListener((View v) -> {
            ...
            // Share the image
            BitmapUtils.sharePhoto(this, mTempPhotoPath);
    ...
    private void launchCamera() {
        ...
        // Create the temporary File where the photo should go
            ...
            File photoFile = null;
            try {
                photoFile = BitmapUtils.createNewTempPhoFile(this);
    ...
    private void processAndSetImage() {
        ...
        mResultsBitmap = BitmapUtils.resamplePho(this, mTempPhotoPath);
